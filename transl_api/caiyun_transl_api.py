...
class CaiyunTransl:
    ...
    def caiyun_translate(self, trans_list: TransList):
        """
        调用彩云API翻译
        """
    ...
    def batch_translate(
        self,filename, trans_list: List[Translate], num_pre_request: int
    ) -> List[Translate]:
        """调用彩云批量翻译这个transList
        ...
        Returns:
            List[Translate]: 翻译好的transList，不过没啥用
        """
