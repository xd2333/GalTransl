...
class BackendSettings(QGroupBox):
    ...
    def init_ui(self):
        ...
        self.sakura_endpoints = CustomTextEdit(self)
        self.sakura_endpoints.setPlaceholderText("SakuraLLM 的 endpoints, 每行一个")
        self.sakura_endpoints.setText("http://127.0.0.1:8080")
        ...
        sakura_layout.addWidget(QLabel("API Endpoints"))
        sakura_layout.addWidget(self.sakura_endpoints)
