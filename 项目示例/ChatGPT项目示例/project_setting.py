import os
from chatgpt_transl_api import *
...
transl_api.line_breaks_improvement_mode = line_breaks_improvement_mode
transl_api.restore_context_mode = restore_context_mode
